                ...
                <HandDrawnFrame key={event.id} contentClassName="px-4 py-3">
                  <article data-calendar-row className="flex md:flex-row flex-col items-center justify-between gap-x-10 gap-y-2 text-center">
                    <div className="min-w-[15em]">
                      <HandwrittenText fontSize={14} mobileFontSize={10} strokeColor="#f4f4f5" strokeWidth={1.7} textAlign="center" animation={getWhenDisplayLabel(event.startDateTime) === "TONIGHT" ? "jitter" : "none"}>
                    ...
                    <div className="flex items-center justify-between md:gap-x-6 gap-x-3 gap-y-2 flex-wrap grow">
                      <div className="flex flex-col items-center align-center justify-center grow">
                        ...
                        <HandwrittenText fontSize={11} mobileFontSize={9} strokeColor="#d4d4d8" strokeWidth={1.5} textAlign="center" animation={getWhenDisplayLabel(event.startDateTime) === "TONIGHT" ? "jitter" : "none"}>
                      ...
                      <div className="flex flex-col items-center align-center justify-center grow">
                        ...
                        <HandwrittenText fontSize={11} mobileFontSize={9} strokeColor="#d4d4d8" strokeWidth={1.5} textAlign="center" animation={getWhenDisplayLabel(event.doorsDateTime) === "TONIGHT" ? "jitter" : "none"}>
